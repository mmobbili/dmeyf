...
particionar( dataset, division=c(70,30), agrupa="clase_ternaria", seed= 174763 )  #Cambiar por la primer semilla de cada uno !
...
pdf(file ="C:/Users/Marcos/Documents/Maestria/DMEyF/work/MiPrimerArbol_01.pdf", paper="usr" )
