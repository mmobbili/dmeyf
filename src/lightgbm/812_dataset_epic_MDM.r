...
directory.root  <-  "C:/Users/Marcos/Documents/Maestria/DMEyF"  #Google Cloud
...
palancas$variablesdrift  <- c("internet","tmobile_app", "cmobile_app_trx", "Master_Finiciomora", "Master_fultimo_cierre", "Visa_Finiciomora", "Visa_fultimo_cierre")   #aqui van las columnas que se quieren eliminar

palancas$corregir <-  TRUE    # TRUE o FALSE

palancas$nuevasvars <-  FALSE #TRUE  #si quiero hacer Feature Engineering manual
...
AgregarVariables  <- function( dataset )
{
  ...
  #dataset[ , mv_status08       := Master_cconsumos +  Visa_cconsumos ]
...
CanaritosImportancia  <- function( dataset )
{
  ...
  param <- list( objective= "binary",
                 ...
                 max_bin= 29,            #por ahora, lo dejo fijo
