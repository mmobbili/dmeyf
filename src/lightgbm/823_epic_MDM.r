...
switch ( Sys.info()[['sysname']],
         Windows = { directory.root  <-  "C:/Users/Marcos/Documents/Maestria/DMEyF" },   #Windows
...
ktrain_subsampling  <- 0.9   #el undersampling que voy a hacer de los continua
...
campos_malos  <- c("internet","tmobile_app", "cmobile_app_trx", "Master_Finiciomora", "Master_fultimo_cierre", "Visa_Finiciomora", "Visa_fultimo_cierre")   #aqui se deben cargar todos los campos culpables del Data Drifting
