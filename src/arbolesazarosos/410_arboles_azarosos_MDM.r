...
setwd("C:/Users/Marcos/Documents/Maestria/DMEyF")  #Establezco el Working Directory
...
campos_buenos  <- setdiff(  colnames(dtrain) ,  c("clase_ternaria", "internet", "cmobile_app_trx", "Master_Finiciomora") )

parametros  <-  list( "cp"=-0.759403536, "minsplit"=1338,  "minbucket"=241, "maxdepth"=15 )
...
fwrite( entrega, 
        file="./kaggle/arboles_azarosos_001_MDM.csv", 
        sep="," )
